...
<table width = "800" border = "-1">
	<tr>
		...
		<td>f_address</td>
		<td><input type = "content" name = "f_address" id="f_address" value = "${Rvo.f_address}"></td>
		<td>f_detailaddress</td>
		<td><input type = "text" name = "f_detailaddress" id="f_detailaddress" value = "${Rvo.f_detailaddress}"></td>
		<td>f_areacode</td>
...
<!-- <div id="lnk" hidden="true"><a href="http://www.naver.com">[링크로 이동]</a></div> -->
